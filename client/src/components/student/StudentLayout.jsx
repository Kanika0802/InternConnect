...
import { LayoutDashboard, Briefcase, FileText, UserCircle, LogOut, Menu, Rocket } from 'lucide-react';
      ...
      <div className="px-6 py-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-indigo-600 font-medium tracking-wide">Student Portal</div>
          </div>
        </div>
      </div>
    ...
    <div className="flex h-screen bg-[#d0e3f6] overflow-hidden">
      ...
      {sidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 bg-white shadow-2xl"><Sidebar /></div>
        </div>
      )}
